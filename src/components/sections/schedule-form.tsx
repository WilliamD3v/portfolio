                  ...
                  {!submitted ? (
                    ...
                    <>
                      ...
                      <button
                        type="button"
                        onClick={() => setShowMobileSummary((prev) => !prev)}
                        className="shrink-0 rounded-xl border border-emerald-400/20 bg-emerald-400/10 px-3 py-2 text-xs font-bold text-emerald-200 transition hover:bg-emerald-400/15"
                      >
                        {showMobileSummary ? "Ocultar" : "Detalhes"}
                      </button>
                    </>
                  )}
                </div>
                    ...
                    {!submitted ? (
                      <div className="space-y-3 text-sm text-slate-200">
                        ...
                        <div className="rounded-[1.15rem] border border-white/10 bg-white/5 p-3">
                          ...
                          <p className="mt-1.5 font-medium leading-6 text-slate-300">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="rounded-[1.15rem] border border-emerald-400/20 bg-emerald-400/10 p-3 text-sm leading-6 text-emerald-200">
                          Sua solicitação foi enviada com sucesso. Guarde o
                          número do seu atendimento.
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    {services.map((service) => (
                      <button
                        ...
                        className={`${cardClass} ${selectedService === service
